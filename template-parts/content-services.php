...
<?php 
     if(class_exists('ACF')){
        $services_subtitle = get_field('services_subtitle', 'options');
        $services_title = get_field('services_title', 'options');
        $services_order = get_field('services_order', 'options');
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php echo $services_subtitle;?></h5>
                <h1 class="mb-0"><?php echo $services_title;?></h1>
            </div>
            <div class="row g-5">
                <?php
                    $args = array(
