<?php
    ...
    $about_info_text = get_field('about_info_text', 'options');
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row g-0 mb-3">
                        ...
                        ?>
                            <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                                <h5 class="mb-3"><i class="<?php echo esc_attr($feature['features_icon']);?>"></i><?php echo $feature['features_text'];?></h5>
                            </div>
                        <?php
                            }
                        ?>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">                            <h5 class="mb-2"><?php echo $about_info_text;?></h5>
                            </h4>
                        </div>
                    </div>
