...
<?php 
    ...
    $quote_info_text     = get_field('quote_info_text', 'options');
    $quote_form_shortcode= get_field('quote_form_shortcode', 'options');
?>
            ...
            <div class="col-lg-7">
                ...
                <div class="row gx-3">
                    ...
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <h5 class="mb-4"><i class="<?php echo esc_attr($feature['icon']);?> text-primary me-3"></i><?php echo $feature['text'];?></h5>
                    </div>
                    <?php
                        }
                    ?>
                ...
                <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <div class="ps-4">
                        ...
                        <h4 class="text-primary mb-0"><?php echo $quote_info_text;?></h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
